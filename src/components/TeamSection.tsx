...
const team = [
  ...
  { name: "Dott.ssa Alida Likey", role: "Dottoranda in Biomedical Sciences", desc: "Specializzata in biologia della pelle e cosmetologia anti-aging.", image: alidaLikey },
